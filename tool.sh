update_Termux-New-Look () {
	...
	apt upgrade
	apt install git
	git clone https://github.Com/rooted-cyber/Termux-Tools
	cd Termux-Tools
	bash tool.sh
	}
auto_update () {
...
printf "\e[0m"
printf "\e[1;96m\n===============================================\n\e[96m"
printf "\e[1;96m 	[~] Termux-Tools  	\e[0m\n"
printf "\e[1;96m===============================================\n\e[0m"
echo
lal="\033[91m"
hara="\033[92m"
ajib="\033[96m"
printf "\n	\033[91m Your Termux-Tools is old version.\n"
...
wget https://raw.githubusercontent.com/rooted-cyber/Termux-Tools/master/.changelog.sh > /dev/null 2>&1
bash .changelog.sh
rm -f .changelog.sh
printf "\n"
...
printf "\e[0m"
printf "\e[1;96m\n===============================================\n\e[96m"
printf "\e[1;96m 	[~] Termux-Tools  V3.9	\e[0m\n"
printf "\e[1;96m===============================================\n\e[0m"
echo
printf "\033[1;92m"
printf "\e[91m[ 1 ]\033[92m Open Termux	\e[91m[ 2 ]\e[93m Termux-Tools\n"
printf "\e[91m[ 3 ]\033[92m Termux-Common	\033[91m[ 4 ]\033[93m Convert into Termux-New-Look\n"
...
echo
toilet -F gay -f term ==============================================
printf "\033[95m	[ T ] Termux-Tools Uninstalled\033[0m\n"
toilet -F gay -f term ==============================================
echo
printf "\e[1;96m\n===============================================\e[96m"
printf "\e[1;96m\n	[ U ] Update Termux-Tools$ver		\e[0m"
printf "\e[1;96m\n===============================================\e[0m"
printf "\e[92m\n\n"
...
clear
cd $HOME
echo -e "\033[91m [+] \033[92m Deleting Termux-Tools"
...
cd ~
echo -e "[√] Cloning tool......"
git clone https://github.com/rooted-cyber/Termux-New-Look > /dev/null 2>&1
cd Termux-New-Look
bash setup.sh
fi
if [ "$a" = "5" ];then
